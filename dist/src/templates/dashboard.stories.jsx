...
const Template = () => {
    ...
    return (<>
      <Header left={<Logo variant="blank"/>} middle={<Menubar variant="transparent">
          ...
          </Menubar>} right={<Avatar src="https://i.pravatar.cc/150" alt="User Avatar" size="small"/>}/>
      <Layout>
        <Tabs defaultValue="pages">
          ...
          <TabsContent value="pages">
            <Table>
              ...
              <TableBody>
                {pagesData.pages.map((page) => (<TableRow key={page.id}>
