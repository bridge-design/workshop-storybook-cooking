...
const badgeStatuses = ['planned', 'in progress', 'done'];
const DoneIcon = ({ className }) => {
    const iconClassName = className
        ? `${cm.badgeIcon} ${className}`
        : cm.badgeIcon;
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={iconClassName} aria-hidden="true">
...
export const Badge = ({ status, children, className, ...props }) => {
    ...
    const rootClassName = composeClassName(`${cm.badge} ${statusClass}`, className);
    return (<span className={rootClassName} {...props}>
