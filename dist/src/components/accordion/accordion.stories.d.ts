...
declare const meta: {
    title: string;
    component: {
        ({ className, children, ...props }: import("@/src/components").AccordionProps): React.JSX.Element;
        displayName: string;
        Item: {
            ({ className, children, ...props }: import("@/src/components").AccordionItemProps): React.JSX.Element;
            displayName: string;
        };
        Trigger: {
            ({ className, children, ...props }: import("@/src/components").AccordionTriggerProps): React.JSX.Element;
            displayName: string;
        };
        Content: {
            ({ className, children, ...props }: import("@/src/components").AccordionContentProps): React.JSX.Element;
            displayName: string;
        };
        Indicator: {
            ({ className, ...props }: import("@/src/components").AccordionIndicatorProps): React.JSX.Element;
            displayName: string;
        };
    };
    parameters: {
